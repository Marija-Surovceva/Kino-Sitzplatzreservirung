...
//
function myFunction(){
  let selectedsitze = JSON.parse(localStorage.getItem("selectedsitze"));
  let reservierung = JSON.stringify(selectedsitze);
  console.log(reservierung);
  document.getElementById('Eingabe').value = reservierung;
